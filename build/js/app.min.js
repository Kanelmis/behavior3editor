...
b3e.Root={name:"Root",category:"root",title:"A behavior tree"},b3e.Cat={name:"Label",category:"special",title:"Labels"};
...
!function(){"use strict";var e=function(e){this.Container_constructor(),this._id=b3.createUUID(),this._editor=e,this._selectedTree=null,this._clipboard=null,this._nodes={},this.trees=null,this.nodes=null,this.history=null,this._initialize()},t=createjs.extend(e,createjs.Container);t._initialize=function(){this.trees=new b3e.project.TreeManager(this._editor,this),this.nodes=new b3e.project.NodeManager(this._editor,this),this.history=new b3e.project.HistoryManager(this._editor,this),this.nodes.add(b3e.Root,!0),this.nodes.add(b3.Sequence,!0),this.nodes.add(b3.Priority,!0),this.nodes.add(b3.MemSequence,!0),this.nodes.add(b3.MemPriority,!0),this.nodes.add(b3.Repeater,!0),this.nodes.add(b3.RepeatUntilFailure,!0),this.nodes.add(b3.RepeatUntilSuccess,!0),this.nodes.add(b3.MaxTime,!0),this.nodes.add(b3.Inverter,!0),this.nodes.add(b3.Limiter,!0),this.nodes.add(b3.Failer,!0),this.nodes.add(b3.Succeeder,!0),this.nodes.add(b3.Runner,!0),this.nodes.add(b3.Error,!0),this.nodes.add(b3.Wait,!0),this.nodes.add(b3e.Cat,!0),this._applySettings(this._editor._settings),this.history.clear(),this._editor.clearDirty()},t._applySettings=function(e){this.trees._applySettings(e),this.nodes._applySettings(e),this.history._applySettings(e)},b3e.project.Project=createjs.promote(e,"Container")}();
...
b3e.editor.ConnectionSystem=function(o){"use strict";var n=null,t=null;this.update=function(o){},this.onMouseDown=function(e){if(1===e.nativeEvent.which){var i=o.project.get();if(i){var c=i.trees.getSelected();if(c){var r=c.view.getLocalPoint(),s=r.x,l=r.y,u=c.blocks.getUnderPoint(s,l);if(!n&&u)if(u._hitOutAnchor(s,l))n=c.connections.add(u,null);else if(u._hitInAnchor(s,l)){var a=u._inConnection;if(!a)return;u._inConnection=null,a._outBlock=null,t=u,n=a}}}}},this.onMouseMove=function(t){if(n){var e=o.project.get();if(e){var i=e.trees.getSelected();if(i){var c=i.view.getLocalPoint(),r=c.x,s=c.y;n._redraw(null,null,r,s)}}}},this.onMouseUp=function(e){if(1===e.nativeEvent.which&&n){var i=o.project.get();if(i){var c=i.trees.getSelected();if(c){var r=c.view.getLocalPoint(),s=r.x,l=r.y,u=c.blocks.getUnderPoint(s,l);if(i.history._beginBatch(),u&&u!==n._inBlock&&"root"!==u.category){var a;u._inConnection&&(a=u._inConnection,c.connections.remove(a)),("root"===n._inBlock.category||"decorator"===n._inBlock.category)&&n._inBlock._outConnections.length>1&&(a=n._inBlock._outConnections[0],c.connections.remove(a)),n._outBlock=u,u._inConnection=n;var _=[c.connections,c.connections._remove,[u]],v=[c.connections,c.connections.add,[n._inBlock,u]];i.history._add(new b3e.Command(_,v)),n._redraw()}else t&&(t._inConnection=n,n._outBlock=t),c.connections.remove(n);i.history._endBatch(),n=null,c.blocks.each(function(n){function t(n){var t=n._outConnections.slice(0);"horizontal"===o._settings.get("layout")?t.sort(function(o,n){return o._outBlock.y-n._outBlock.y}):t.sort(function(o,n){return o._outBlock.x-n._outBlock.x});for(var e=[],i=0;i<t.length;i++){e.push(t[i]._outBlock.id);var c=t[i]._outBlock.title.replace(/\[.*?\]/,"["+i+"-"+t[i]._outBlock.id.slice(t[i]._outBlock.id.length-4)+"]");t[i]._outBlock.title=c,t[i]._outBlock._redraw()}return e}t(n)})}}}},o._game.stage.on("stagemousedown",this.onMouseDown,this),o._game.stage.on("stagemousemove",this.onMouseMove,this),o._game.stage.on("stagemouseup",this.onMouseUp,this)};
b3e.editor.DragSystem=function(e){"use strict";var t=!1,o=0,n=0;this.update=function(e){},this.onMouseDown=function(i){if(1===i.nativeEvent.which&&!i.nativeEvent.ctrlKey&&!t){var s=e.project.get();if(s){var c=s.trees.getSelected();if(c){var r=c.view.getLocalPoint(),a=r.x,l=r.y,_=c.blocks.getUnderPoint(a,l);if(_&&_._isSelected&&_._hitBody(a,l)){t=!0,o=a,n=l;for(var u=0;u<c._selectedBlocks.length;u++)_=c._selectedBlocks[u],_._isDragging=!0,_._dragOffsetX=a-_.x,_._dragOffsetY=l-_.y}}}}},this.onMouseMove=function(o){if(t){var n=e.project.get();if(n){var i=n.trees.getSelected();if(i)for(var s=i.view.getLocalPoint(),c=s.x,r=s.y,a=0;a<i._selectedBlocks.length;a++){var l=i._selectedBlocks[a],_=c-l._dragOffsetX,u=r-l._dragOffsetY;l.x=_,l.y=u,l._snap(),l._inConnection&&l._inConnection._redraw();for(var g=0;g<l._outConnections.length;g++)l._outConnections[g]._redraw()}}}},this.onMouseUp=function(i){if(1===i.nativeEvent.which&&t){var s=e.project.get();if(s){var c=s.trees.getSelected();if(c){t=!1;var r=c.view.getLocalPoint();r.x,r.y;s.history._beginBatch();for(var a=0;a<c._selectedBlocks.length;a++){var l=c._selectedBlocks[a];l._isDragging=!1;var _=[l,o-l._dragOffsetX,n-l._dragOffsetY],u=[l,l.x,l.y];if(_[1]===u[1]&&_[2]===u[2])break;s.history._add(new b3e.Command([c.blocks,c.blocks._move,_],[c.blocks,c.blocks._move,u]))}s.history._endBatch(),c.blocks.each(function(t){function o(t){var o=t._outConnections.slice(0);"horizontal"===e._settings.get("layout")?o.sort(function(e,t){return e._outBlock.y-t._outBlock.y}):o.sort(function(e,t){return e._outBlock.x-t._outBlock.x});for(var n=[],i=0;i<o.length;i++){n.push(o[i]._outBlock.id);var s;s=/\[.*?\]/.test(o[i]._outBlock.title)?o[i]._outBlock.title.replace(/\[.*?\]/,"["+i+"-"+o[i]._outBlock.id.slice(o[i]._outBlock.id.length-4)+"]"):"["+i+"-"+o[i]._outBlock.id.slice(o[i]._outBlock.id.length-4)+"]  "+o[i]._outBlock.title,o[i]._outBlock.title=s,o[i]._outBlock._redraw()}return n}o(t)})}}}},e._game.stage.on("stagemousedown",this.onMouseDown,this),e._game.stage.on("stagemousemove",this.onMouseMove,this),e._game.stage.on("stagemouseup",this.onMouseUp,this)};
...
!function(){"use strict";function e(e,t,o,r){function n(){g.trees=[],g.nodes={composite:[],decorator:[],action:[],condition:[],special:[]};var e=t.editor.project.get(),o=e.trees.getSelected();e.trees.each(function(e){var t=e.blocks.getRoot();v(t)||g.trees.push({id:e._id,name:t.title||"A behavior tree",active:e===o,index:g.trees.length})}),g.trees.sort(function(e,t){return e.name.toLowerCase().charCodeAt(0)-t.name.toLowerCase().charCodeAt(0)}),e.nodes.each(function(e){if("tree"!==e.category&&!v(e)){var t=g.nodes[e.category];t&&t.push({name:e.name,title:s(e),isDefault:e.isDefault,index:t.length})}});for(var r in g.nodes)g.nodes[r].sort(function(e,t){return 1==e.isDefault&&1==t.isDefault?e.index-t.index:e.isDefault?-1:t.isDefault?1:e.title.toLowerCase().charCodeAt(0)-t.title.toLowerCase().charCodeAt(0)})}function i(t){setTimeout(function(){e.$apply(function(){n()})},0)}function d(){t.editor.on("treenodechanged",i),t.editor.on("noderemoved",i),t.editor.on("nodeadded",i),t.editor.on("treeadded",i),t.editor.on("treeselected",i),t.editor.on("treeremoved",i),t.editor.on("treeimported",i)}function c(){t.editor.off("treenodechanged",i),t.editor.off("noderemoved",i),t.editor.off("nodeadded",i),t.editor.off("treeadded",i),t.editor.off("treeselected",i),t.editor.off("treeremoved",i),t.editor.off("treeimported",i)}function s(e){var t=e.title||e.name;return t=t.replace(/(<\w+>)/g,function(e,t){return"@"})}function l(){var e=t.editor.project.get();e.trees.add()}function a(e){var o=t.editor.project.get();o.trees.select(e)}function f(e){o.confirm("Remove tree?","Are you sure you want to remove this tree?\n\nNote: all blocks using this tree will be removed.").then(function(){var o=t.editor.project.get();o.trees.remove(e),r.success("Tree removed","The tree has been removed from this project.")})}function u(){n()}function v(e){if(null!==g.filter||void 0!==g.filter||0==g.filter.replace(/(^s*)|(s*$)/g,"").length){var o=new RegExp(g.filter,"i"),r=t.editor.project.get(),n=r.trees.getSelected();return n.selection.deselectAll(),n.blocks.each(function(e){var t=e.title.replace(/\[.*?\]/,e.id.slice(e.id.length-4)),o=t.trim().substring(0,4);if(g.filter==o){console.log("good luck dude"),n.selection.selectSubtree(e),n._selectionBox.visible=!0;var r=n.view.getLocalPoint();r.x,r.y}else console.log("Hhaa nigger, You searched for a null.")}),-1==s(e).search(o)}return!0}var g=this;g.nodes=null,g.newTree=l,g.select=a,g.remove=f,g.search=u,g.filter="",d(),n(),e.$on("$destroy",c)}angular.module("app").controller("NodespanelController",e),e.$inject=["$scope","$window","dialogService","notificationService"]}();
...
!function(){"use strict";function e(e){function o(o,n,r){o.keytable.heading=r.heading,o.keytable._onChange=e(r.ngChange);var l=r.ngModel;o.$watch(l,function(e){o.keytable.reset(e)})}var n={require:"^ngModel",restrict:"EA",replace:!0,bindToController:!0,controller:"KeyTableController",controllerAs:"keytable",templateUrl:"directives/keytable.html",link:o};return n}function o(e){function o(){if(a.model)for(var e in a.model)r(e,a.model[e],!1);else a.model={}}function n(e){a.rows=[],a.model=e,o()}function r(e,o,n){a.rows.push({key:e,value:JSON.stringify(o),fixed:n===!0})}function l(o){a.rows.splice(o,1);for(var n in a.model)a.model.hasOwnProperty(n)&&delete a.model[n];0==a.rows.length&&a._onChange(e);for(var r=0;r<a.rows.length;r++){var l=a.rows[r],t=l.value;try{t=JSON.parse(t)}catch(i){}a.model[l.key]=t,a._onChange(e)}}function t(){for(var o in a.model)a.model.hasOwnProperty(o)&&delete a.model[o];for(var n=0;n<a.rows.length;n++){var r=a.rows[n];if(r.key){var l=r.value;try{l=JSON.parse(l)}catch(t){}a.model[r.key]=l,a._onChange&&a._onChange(e)}}}var a=this;a._onChange=null,a.model=e.keytable.model||e.model||null,a.rows=[],a.add=r,a.remove=l,a.change=t,a.reset=n,o()}angular.module("app").directive("b3KeyTable",e).controller("KeyTableController",o),e.$inject=["$parse"],o.$inject=["$scope"]}();
...
!function(){"use strict";function t(t,e,n,r,o,c,a){function i(){r.save(P,g)}function u(t){if(t){for(var e=g.length-1;e>=0;e--)g[e].path===t.path?g.splice(e,1):g[e].isOpen=!1;var n={name:t.name,description:t.description,path:t.path,isOpen:!0};g.splice(0,0,n)}else for(var r=0;r<g.length;r++)g[r].isOpen=!1;i()}function s(t){y=t,u(t),e.$broadcast("dash-projectchanged")}function p(){return t(function(t,e){if(!g){var n;try{n=r.load(P)}catch(o){}n||(n=[]),g=n}t(g)})}function f(e,n){return t(function(t,r){var o={name:n,description:"",data:[],path:e};a.newProject(),o.data=a.exportProject(),d(o).then(function(){s(o),t()})})}function l(){return y}function d(e){return e=e||y,e.data=a.exportProject(),t(function(t,c){n.editor.clearDirty(),o.isDesktop?r.save(e.path,JSON3.stringify(e,null,2)):r.save(e.path,e),u(e),t()})}function h(e){return t(function(t,n){try{var c=r.load(e);o.isDesktop&&(c.path=e),a.openProject(c.data),s(c),t()}catch(i){console.error(i),n(i)}})}function j(){return t(function(t,e){n.editor.clearDirty(),a.closeProject(),s(null),t()})}function v(e){return t(function(t,n){for(var r=0;r<g.length;r++)if(g[r].path===e){g.splice(r,1);break}i(),t()})}var P=o.join(o.getDataPath(),"recents.json"),g=null,y=null,S={getRecentProjects:p,newProject:f,getProject:l,saveProject:d,openProject:h,closeProject:j,removeProject:v};return S}angular.module("app").factory("projectModel",t),t.$inject=["$q","$rootScope","$window","storageService","systemService","localStorageService","editorService"]}();
